  ...
  describe('Goal Operations', () => {
    ...
    test('should list all goals', async () => {
      const goals = [
        ...
        { id: 'g-test04', title: 'Goal 2', status: 'in_progress' as GoalStatus },
    ...
    test('should list goals by status', async () => {
      const goals = [
        ...
        { id: 'g-test08', title: 'Goal 3', status: 'in_progress' as GoalStatus }
      ];
      ...
      expect(inProgressGoals.every(g => g.status === 'in_progress')).toBe(true);
    });
    ...
    test('should get goal count by status', async () => {
      const goals = [
        ...
        { id: 'g-test12', title: 'Goal 3', status: 'in_progress' as GoalStatus },
    ...
    test('should find goal by branch name', async () => {
      ...
      const foundGoal = await storageService.findGoalByBranch('feature/test-branch');
      expect(foundGoal).toBeTruthy();
